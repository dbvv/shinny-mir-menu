...
<div class="content">
      ...
      <div class="box box_catalog product-search">
        <div class="box__inner">
          ...
          <div class="catalog">
            ...
            <div class="catalog__column catalog__column_right">
...
<?php if (isset($_GET['radiusd'])) { ?>
$('.bff').each(function(){
	if ($(this).data('idd') == 'a19' && $.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['radiusd']); ?>') {
...
$('.bff').each(function(){
	if ($(this).data('idd') == 'a14' && $.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['radius']); ?>') {
		$(this).prop('checked', true);
	}
});
<?php } ?>
<?php if (isset($_GET['krepezh'])) { ?>
$('.bff').each(function(){
	if ($(this).data('idd') == 'a20' && $.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['krepezh']); ?>') {
		$(this).prop('checked', true);
	}
});
<?php } ?>
...
$('.bff').each(function(){
	if ($(this).data('idd') == 'a13' && ($.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['height']); ?>' || $.trim($(this).parent().next().find('label').text()) == '<?php echo $_GET['height']; ?>')) {
		$(this).prop('checked', true);
	}
});
<?php } ?>
<?php if (isset($_GET['sezon'])) { ?>
$('.bff').each(function(){
	if ($(this).data('idd') == 'a18' && $.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['sezon']); ?>') {
		$(this).prop('checked', true);
	}
});
<?php } ?>
<?php if (isset($_GET['widthd'])) { ?>
$('.bff').each(function(){
	if ($(this).data('idd') == 'a27' && ($.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['widthd']); ?>' || $.trim($(this).parent().next().find('label').text()) == '<?php echo $_GET['widthd']; ?>')) {
		$(this).prop('checked', true);
	}
});
<?php } ?>
...
$('.bff').each(function(){
	if ($(this).data('idd') == 'a12' && ($.trim($(this).parent().next().find('label').text()) == '<?php echo str_replace('.',',',$_GET['width']); ?>' || $.trim($(this).parent().next().find('label').text()) == '<?php echo $_GET['width']; ?>')) {
		$(this).prop('checked', true);
	}
});
<?php } ?>
<?php if (isset($_GET['filter_manufacturer_id'])) { ?>
$('.bff').each(function(){
	if ($(this).val() == '<?php echo $_GET['filter_manufacturer_id']; ?>' && $(this).data('idd') == 'm0') {
		$(this).prop('checked', true);
	}
});
<?php } ?>
