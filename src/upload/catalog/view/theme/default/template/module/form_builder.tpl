...
<div id="form-builder-<?php echo $settings['module_id']; ?>" class="form-builder box">
	...
	<div class="box-content">
		...
		<div class="field-block">
			<a class="button btn btn-primary" onclick="submitForm($(this), <?php echo $settings['module_id']; ?>)"><?php echo html_entity_decode($settings['submit_button_' . $language], ENT_QUOTES, 'UTF-8'); ?></a>
		</div>
	</div>
</div>
